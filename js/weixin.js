...
/*-----------------------------------微信分享  页面分享--------------------------*/
var dataForWeixin={		
		img:  'http://test.activity.sinreweb.com/Z_Meijiajing/Run/images/share.png', //带加
		url:	'http://test.activity.sinreweb.com/Z_Meijiajing/Run/',
		title:	'美加净·邂逅芬芳',
		desc:	"【美加净】邂逅芬芳，秋日香润之旅"
};
var weixin={
	...
	get:function(){
		...
		if(/micromessenger/gi.test(navigator.userAgent.toLowerCase())){			
			$.get('http://xm.games.sinreweb.com/Xiaoming/JsConfig/getSignPackage',{url:location.href},function(res){										
				if(res.err==0){
					//console.log(res)
	...
	},openCard:function(list,success){ //查看卡券
	    var list=list || [{cardId:"",code:""}];
		wx.openCard({
           cardList: list,
           success:function(res){
           	  success && success(res);
	...
	},chooseWXPay:function(time,non,pack,pay,success){//支付
		wx.chooseWXPay({
			timestamp: time || 1414723227,
            nonceStr: non || 'noncestr',
            package: pack || 'addition=action_id%3dgaby1234%26limit_pay%3d&bank_type=WX&body=innertest&fee_type=1&input_charset=GBK&notify_url=http%3A%2F%2F120.204.206.246%2Fcgi-bin%2Fmmsupport-bin%2Fnotifypay&out_trade_no=1414723227818375338&partner=1900000109&spbill_create_ip=127.0.0.1&total_fee=1&sign=432B647FE95C7BF73BCD177CEECBEF8D',
            paySign: pay || 'bd5b1933cda6e9548862944836a9b52e8c9a2b69',
            success:function(res){
            	success && success(res);
            }
		})
